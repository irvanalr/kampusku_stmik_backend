...
const otentikasiListDataMahasiswaOnlyNameModel = require("../models/otentikasiListDataMahasiswaOnlyNameModel");
require('dotenv').config();

const getDataMahasiswaByName = (req, res) => {
    // cek headers
    ...
    otentikasiListDataMahasiswaOnlyNameModel.getAllTableDosen( (err, responseGetAllTableDosen) => {
        ...
        jwt.verify(authHeader, process.env.credentialdosen, (err, decode) => {
            ...
            otentikasiListDataMahasiswaOnlyNameModel.getAllTableMahasiswa(dosen.id, (err, responseGetAllTableMahasiswa) => {
